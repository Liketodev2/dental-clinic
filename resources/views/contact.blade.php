            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md col-lg-6 mt-4 mt-md-0">
                        <form class="contact-form" id="contactForm" method="post"  method="POST" action="{{route('contact-form')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mt-15">
                                <input type="text" class="form-control" name="whatsapp" required placeholder="WhatsApp Number*">
                            </div>
                            @error('phone')
                            <span class="invalid-feedback d-block" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
...
{{--                            @enderror--}}
                            <div class="mt-15">
                                <div class="avatar-upload">
                                    <div class="avatar-edit">
                                        <input type="file" required name="file" id="imageUpload" accept=".png, .jpg, .jpeg" />
                                ...
                                <div class="modal-dialog">
                                    ...
                                    {{--     <form action="#">--}}
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input type="radio" id="Male" name="radio-group1" value="male" checked>
                                                            <label for="Male">Male</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="Female" value="female" name="radio-group1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input type="radio" id="HaveDentist" name="radio-group2" value="yes" checked>
                                                            <label for="HaveDentist">Yes</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="HaveNotDentist" value="no" name="radio-group2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea required name="suggest" id="" class="form-control"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label> Did they take a panoramic x-ray?</label>
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input   type="radio" id="x-ray" value="yes" name="radio-group3" checked>
                                                            <label for="x-ray">Yes</label>
                                                        </div>
                                                        <div>
                                                            <input   type="radio" id="not-x-ray" value="no" name="radio-group3">
                                                    ...
                                                    <div class="ifYes">
                                                        ...
                                                        <div>
                                                            <input required type="file" name="modal_files">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">How’s your general health?</label>
                                                    <input required type="text" name="health" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">What are you hoping to accomplish with your teeth (specifically)?</label>
                                                    <input required type="text" class="form-control" name="teeth">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">How long have you delayed taking care of the issue due to finances?</label>
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input type="radio" id="finances" value="yes" name="radio-group4" checked>
                                                            <label for="finances">Yes</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="nofinances" value="no" name="radio-group4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input type="radio" id="visited" value="yes" name="radio-group5" checked>
                                                            <label for="visited">Yes</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="novisited" value="no" name="radio-group5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input type="radio" id="visitedDental" value="yes" name="radio-group6" checked>
                                                            <label for="visitedDental">Yes</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="novisitedDental" value="no" name="radio-group6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date_teeth" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Would you have someone come with you for the procedure(s)?</label>
                                                    <div class="d-flex">
                                                        <div class="mr-3">
                                                            <input  type="radio" value="yes" id="procedure" name="radio-group7" >
                                                            <label for="procedure">Yes</label>
                                                        </div>
                                                        <div >
                                                            <input type="radio" id="noprocedurel" value="no" name="radio-group7" checked>
                                                            <label for="noprocedurel">No</label>
                                                        </div>
                                                    </div>
                                                    <div class="d-none ifYes">
                                                        <label for="">If yes, please give us their:</label>
                                                        <input name="additional_name" type="text" class="form-control mb-2" placeholder="Name">
                                                        <input name="additional_email" type="text" class="form-control mb-2" placeholder="Email">
                                                        <input name="additional_age" type="text" class="form-control mb-2" placeholder="Age">
                                                    </div>
                                                </div>
                                        {{--    </form>--}}
                                        </div>
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-hover-fill btn-contact-main"><i class="icon-right-arrow"></i><span>Send message</span><i class="icon-right-arrow"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    <script>
        $('.btn-contact-main').on('click', function () {
            $('.mdi-cursor-pointer').submit();
        })
