                        ...
                        <nav class="navbar navbar-expand-lg btco-hover-menu">
                            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('brenes_gallery')}}" class="nav-link dropdown-toggle" data-toggle="dropdown">Smiles Gallery</a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href="{{route('blog')}}" class="nav-link dropdown-toggle" data-toggle="dropdown">Blog</a>
                                        <ul class="dropdown-menu">
