    ...
    <div class="quickLinks js-quickLinks">
		...
		<path d="M123.856,71.638H105.66c2.737-20.263,13.941-21.281,19.097-21.75c5.151-0.469,9.094-4.787,9.094-9.959V10.004
			...
			<path d="M217.875,159.668c-24.237,0-43.886,19.648-43.886,43.886c0,24.237,19.648,43.886,43.886,43.886
				...
				C240.863,216.249,230.571,226.541,217.875,226.541z" fill="#fff"/>
				...
				c4.582-3.168,10.122-4.645,15.674-4.18l284.735,32.914C401.773,81.346,410.203,91.545,409.112,103.035z" fill="#fff"/>
                ...
                <div class="col">
                    <a href="#" class="link">
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 512.056 512.056" style="enable-background:new 0 0 512.056 512.056;width: 40px;margin:10px auto" xml:space="preserve" fill="#fff">
