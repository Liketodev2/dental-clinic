            ...
            <div class="row no-gutters">
                ...
                <div class="col">
                    ...
                    <div class="link-drop">
                        ...
                        <p class="text-right mt-2"><a href="prices.html" class="btn btn-sm btn-hover-fill">Details</a><a href="prices.html" class="btn btn-sm btn-hover-fill">Details</a></p>
                    </div>
                </div>
                <div class="col">
                    <a href="#" class="link">
                    ...
                    <div class="link-drop">
                        ...
                        <p class="text-right mt-2"><a href="{{route('contact')}}" class="btn btn-sm btn-hover-fill">Our Contacts</a></p>
                    </div>
                </div>
